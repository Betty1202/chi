$(function () {
    ...
    var i = 0, a = $(".title"), o = $(".time"), s = $(".what"), c = $(".punctuation"), l = $("#start"),
        r = $("#temp_container"),
        m = [["大餐", "重庆火锅 烧烤 韩式烤肉 川菜 串串 披萨 日料 打边炉 潮汕牛肉 酸菜鱼".split(" ")], ["学校附近", "梧桐蒸碗 螺蛳粉 韩餐 米乐坊 小六汤包 胖胖粉 妈妈花甲 西南门夜市 南门小吃街 梧桐 康桥 米皮凉皮 德克士 肯德基 麻辣烫".split(" ")]],
        ...
        d = 1, p = (new Date).getHours(), f = $(window), g = $("body"), v = $("#wrapper"), x = $(".os"), k = 0,
        w = "human", b, C, E;
    a.on("animationend webkitAnimationEnd", function (t) {
        ...
        if (g.toggleClass("playing", !i), i) i = 0, "monster" == w && x.text(u[t(u.length)]), c.text("！"), l.find("span").text("换一个"), clearTimeout(b), document.title = a.text() + "这是一个很无聊的网站，但能解决你的人生一大困扰！选择困难户必备！"; else {
            i = 1, k++, 2 == k && e("我就知道你会换一个 ( ͡° ͜ʖ ͡°)"), 5 == k && e("说，你是不是天秤座？Σ( ° △ °|||)︴"), 10 == k && e("你是吃了炫迈吗？(￣△￣；)"), 15 == k && e("难道你是处女座？ (๑•̀ㅂ•́)و✧"), 20 == k && e("再换我可要报警了！( *・ω・)✄╰ひ╯");
